...
4. Clone the repository
   ...
   ```
5. Change Directory to CrudBackEndWithMail or Open the cloned folder, navigate to CrudBackEndWithMail, and open the command prompt.
   ```
...
2. node .\KCode\ForBatV9\Backend.js
